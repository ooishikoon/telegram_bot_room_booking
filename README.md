...
5. Update Booking
   ...
   <img src= "images/output/u4_updateB_01.jpg" width=350>
   <img src= "images/output/u4_updateB_02.jpg" width=350>
   <img src= "images/output/u4_updateB_03.jpg" width=350>
   <img src= "images/output/u4_updateB_04.jpg" width=350>

   If the date enter is not available to book yet or the time slot is full on the date.

   <img src= "images/output/u4_updateB_05.jpg" width=350>
   
6. Delete Booking

   <img src= "images/output/u5_deleteB_01.jpg" width=350>
   <img src= "images/output/u5_deleteB_02.jpg" width=350>
   <img src= "images/output/u5_deleteB_03.jpg" width=350>
   
7. Apply Admin

   <img src= "images/output/u6_apply_admin_01.jpg" width=350>
   <img src= "images/output/u6_apply_admin_02.jpg" width=350>
   <img src= "images/output/u6_apply_admin_03.jpg" width=350>
